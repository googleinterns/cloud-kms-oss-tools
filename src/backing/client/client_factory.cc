...
std::unique_ptr<Client> MakeDefaultClient(
  ...
  return absl::make_unique<GrpcClient>(
      grpc_client::CreateKeyManagementServiceStub(
          kDefaultApiEndpoint, grpc::GoogleDefaultCredentials()),
      grpc_client::CreateClientContextFactory(
